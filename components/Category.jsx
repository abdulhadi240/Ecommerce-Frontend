  ...
  return (
    <div>
        <div className='relative text-center group'>
            ...
            <h1 className='text-center text-white focus absolute  tracking-widest brightness-125 text-2xl f top-14 left-16 group-hover:hidden group-hover:transition-all '>{title}</h1>
