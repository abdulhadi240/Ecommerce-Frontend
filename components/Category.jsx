  ...
  return (
    <div>
        <div className='relative text-center group'>
            <Image width={200} height={100} alt='img' src={image} className='w-64  h-36 rounded-2xl brightness-50 border-[1px] border-black group-hover:brightness-100 group-hover:transition-all group-hover:scale-110'/>
